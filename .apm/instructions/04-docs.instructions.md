...
- 安定した判断は ADR、継続的な設計原則は `docs/design-docs/`、機能や施策の仕様は `docs/product-specs/`、外部資料の要約は `docs/references/`、進行中の複雑な作業は `docs/exec-plans/`、繰り返し実行する運用手順は `docs/operations/`、負債は `docs/tech-debt-tracker.md` に置く
