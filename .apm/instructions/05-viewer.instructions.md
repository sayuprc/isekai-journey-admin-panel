---
name: 'Viewer Instructions'
description: 'Use when editing public viewer Astro pages, UI components, generated API clients, or viewer-specific styles in src/viewer. Covers viewer structure, regeneration flow, preserved placeholders, and validation.'
applyTo: "src/viewer/**"
---
...
- API クライアントや型は `src/viewer/src/generated/` を Source of Truth とし、手動編集しない
- API shape を変える場合は `src/contracts` を更新してから `mise run viewer:generate` を使う
