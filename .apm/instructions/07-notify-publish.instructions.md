...
description: 'Use when editing the MoonBit notify-publish CLI in src/notify-publish. Covers module layout, publish-only responsibility, README as contract SoT, and validation.'
applyTo: "src/notify-publish/**"
---
