...
const DEFAULT_PARAMS = {
  name: '',
  sort: 'order_no' as CreatorSearchSortBy,
...
const getInitialParams = () => {
  ...
  return {
    ...
    sort: (params.get('sort') ?? DEFAULT_PARAMS.sort) as CreatorSearchSortBy,
  ...
  return (
    <>
      ...
      <div class="mb-4 flex justify-end">
        <a href="/creators/create" class="btn btn-primary btn-sm">
          新規作成
        </a>
      </div>
        ...
        <table class="table table-zebra">
          ...
          <tbody>
            <Switch>
              ...
              <Match when={data() && data()!.creators.length === 0}>
