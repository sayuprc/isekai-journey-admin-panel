...
export const SearchList = () => {
  ...
  const updateUrl = (params: { name: string; sort: PerformerSearchSortBy; order: SortOrder; page: number; perPage: number }) => {
      ...
      <form onSubmit={handleSearch} class="mb-4 flex flex-wrap items-end gap-4">
        ...
        <fieldset class="fieldset">
          ...
          <select
            ...
            onChange={e => setInputSort(e.currentTarget.value as PerformerSearchSortBy)}
          >
