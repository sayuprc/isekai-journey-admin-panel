 ...
 * 管理ユーザー登録API
 */
export const authenticateServiceRegister = <ThrowOnError extends boolean = false>(options: Options<AuthenticateServiceRegisterData, ThrowOnError>) => (options.client ?? client).post<AuthenticateServiceRegisterResponses, AuthenticateServiceRegisterErrors, ThrowOnError>({
    url: '/auth/register',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * リリース検索API
 */
export const releaseServiceSearchReleases = <ThrowOnError extends boolean = false>(options?: Options<ReleaseServiceSearchReleasesData, ThrowOnError>) => (options?.client ?? client).get<ReleaseServiceSearchReleasesResponses, ReleaseServiceSearchReleasesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/releases/search',
    ...options
});
