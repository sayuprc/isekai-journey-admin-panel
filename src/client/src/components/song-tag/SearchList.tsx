...
import type { SongTagSearchResponse } from '../../generated/types.gen';
...
export const SearchList = () => {
  ...
  const [data] = createResource(
    ...
    async (params) => {
      ...
      return data as unknown as SongTagSearchResponse;
    },
  );
  ...
  const handlePageChange = (p: number) => {
    setPage(p);
    updateUrl({ name: name(), sort: sort(), order: order(), page: p, perPage: perPage() });
  };
  ...
  return (
    <>
      ...
      <div class="mb-4 flex justify-end">
        <a href="/song-tags/create" class="btn btn-primary btn-sm">
          新規作成
        </a>
      </div>
