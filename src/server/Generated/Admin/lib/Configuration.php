...
namespace OpenAPI\Admin\Client;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://local.api.isekaijoucho.fan/admin';
    ...
    {
        $report  = 'PHP SDK (OpenAPI\Admin\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://local.api.isekaijoucho.fan/admin/{version}",
                "description" => "ローカル環境",
                "variables" => [
                    "version" => [
