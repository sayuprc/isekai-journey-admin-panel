...
/**
 * GenerateRecoveryCodesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 ...
 */
class GenerateRecoveryCodesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateRecoveryCodesResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recovery_codes'] === null) {
            $invalidProperties[] = "'recovery_codes' can't be null";
        }
     ...
     * Sets recovery_codes
     *
     * @param string[] $recovery_codes recovery_codes
     *
     * @return self
     */
