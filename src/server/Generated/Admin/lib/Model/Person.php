...
class Person implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Person., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling Person., must be bigger than or equal to 1.');
        }
