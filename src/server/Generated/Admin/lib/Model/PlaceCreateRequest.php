...
/**
 * PlaceCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 ...
 */
class PlaceCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlaceCreateRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PlaceCreateRequest., must be bigger than or equal to 1.');
        }
