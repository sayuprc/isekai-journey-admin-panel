...
/**
 * PlaceUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 ...
 */
class PlaceUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlaceUpdateRequest';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'kind_value' => '\OpenAPI\Admin\Client\Model\PlaceKindValue'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PlaceUpdateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets kind_value
     *
     * @return \OpenAPI\Admin\Client\Model\PlaceKindValue
     */
     ...
     * Sets kind_value
     *
     * @param \OpenAPI\Admin\Client\Model\PlaceKindValue $kind_value kind_value
     *
     * @return self
     */
