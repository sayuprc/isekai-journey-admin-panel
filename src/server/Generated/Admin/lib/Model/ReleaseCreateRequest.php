 ...
 */
class ReleaseCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseCreateRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReleaseCreateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((!preg_match("/^#[0-9a-f]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling ReleaseCreateRequest., must conform to the pattern /^#[0-9a-f]{6}$/.");
        }
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling ReleaseCreateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFormatValues($format_values)
    {
        ...
        if ((count($format_values) < 1)) {
            throw new \InvalidArgumentException('invalid length for $format_values when calling ReleaseCreateRequest., number of items must be greater than or equal to 1.');
        }
