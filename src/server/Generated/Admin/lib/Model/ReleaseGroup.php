...
/**
 * ReleaseGroup Class Doc Comment
 *
 * @category Class
 * @description リリースグループ（作品）
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ReleaseGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseGroup';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ReleaseGroup., must be bigger than or equal to 1.');
        }
