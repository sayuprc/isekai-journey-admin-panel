...
/**
 * ReleaseGroupReferencedRelease Class Doc Comment
 *
 * @category Class
 * @description リリースグループ傘下のリリース 1 件分の概要
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ReleaseGroupReferencedRelease implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseGroupReferencedRelease';
