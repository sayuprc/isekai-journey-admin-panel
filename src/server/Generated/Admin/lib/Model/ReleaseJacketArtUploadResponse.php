...
/**
 * ReleaseJacketArtUploadResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReleaseJacketArtUploadResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseJacketArtUploadResponse';
    ...
    */
    ...
    public function setJacketArtUrl($jacket_art_url)
    {
        if (is_null($jacket_art_url)) {
            throw new \InvalidArgumentException('non-nullable jacket_art_url cannot be null');
        }
