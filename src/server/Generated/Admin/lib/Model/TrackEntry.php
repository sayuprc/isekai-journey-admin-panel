 ...
 */
class TrackEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackEntry';
    ...
    */
    ...
    public function setTrackNo($track_no)
    {
        ...
        if (($track_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $track_no when calling TrackEntry., must be bigger than or equal to 1.');
        }
