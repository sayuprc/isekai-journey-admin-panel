...
namespace OpenAPI\Viewer\Client;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://local.api.isekaijoucho.fan';
    ...
    {
        $report  = 'PHP SDK (OpenAPI\Viewer\Client) Debug Report:' . PHP_EOL;
