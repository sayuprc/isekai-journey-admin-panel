...
/**
 * MediaSongSummary Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Viewer\Client
 * @author   OpenAPI Generator team
 ...
 */
class MediaSongSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MediaSongSummary';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling MediaSongSummary., must be bigger than or equal to 1.');
        }
