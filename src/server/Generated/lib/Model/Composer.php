 ...
 */
class Composer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Composer';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Composer., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling Composer., must be bigger than or equal to 1.');
        }
