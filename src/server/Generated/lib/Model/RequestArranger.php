...
/**
 * RequestArranger Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestArranger implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestArranger';
    ...
    */
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling RequestArranger., must be bigger than or equal to 1.');
        }
