...
/**
 * RequestLyricist Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestLyricist implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestLyricist';
    ...
    */
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling RequestLyricist., must be bigger than or equal to 1.');
        }
