...
/**
 * SongLinkedMedia Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SongLinkedMedia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SongLinkedMedia';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SongLinkedMedia., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling SongLinkedMedia., must be bigger than or equal to 1.');
        }
