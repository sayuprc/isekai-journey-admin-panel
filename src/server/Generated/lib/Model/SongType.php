 ...
 */
class SongType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SongType';
    ...
    {
        $this->setIfExists('song_type_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['song_type_id'] === null) {
            $invalidProperties[] = "'song_type_id' can't be null";
        }
    ...
    {
        return $this->container['song_type_id'];
    }
     ...
     * @return self
     */
    public function setSongTypeId($song_type_id)
    {
        if (is_null($song_type_id)) {
            throw new \InvalidArgumentException('non-nullable song_type_id cannot be null');
        }
        $this->container['song_type_id'] = $song_type_id;
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling SongType., must be bigger than or equal to 1.');
        }
