...
class SongRepositoryTest extends DatabaseTestCase
{
    ...
    public function find(): void
    {
        ...
        $song = $this->createSong($this->generateUuid(), '曲名', '説明', SongType::Original, 1, [], [], []);
    ...
    public function saveUpdatesExisting(): void
    {
        ...
        $song = $this->createSong($this->generateUuid(), '旧タイトル', '旧説明', SongType::Original, 1, [], [], []);
        $repository->save($song);

        $updated = $this->createSong($song->songId->value, '新タイトル', '新説明', SongType::Cover, 2, [], [], []);
    ...
    public function getMaxOrderNo(): void
    {
        ...
        $song1 = $this->createSong($this->generateUuid(), '曲1', '説明', SongType::Original, 10, [], [], []);
        $song2 = $this->createSong($this->generateUuid(), '曲2', '説明', SongType::Original, 30, [], [], []);
        $song3 = $this->createSong($this->generateUuid(), '曲3', '説明', SongType::Original, 20, [], [], []);
