...
export const SITE_DATA = {
  ...
  releases: [
    ...
    { id: 'r03', title: '残響アーカイブ', date: '2024.03.15', type: 'Album', format: 'CD / Digital', label: '—', songIds: ['s03', 's04', 's05', 's06', 's07', 's08'], color: '#2c3e5e', description: '1stフルアルバム。' },
    { id: 'r04', title: '群青の余白', date: '2023.12.08', type: 'Single', format: 'Digital', label: '—', songIds: ['s04'], color: '#4a5a8a' },
    { id: 'r05', title: '雪明かり', date: '2023.10.22', type: 'Single', format: 'Digital', label: '—', songIds: ['s05'], color: '#9bb5d0' },
    { id: 'r06', title: '燈籠草', date: '2023.06.14', type: 'Single', format: 'CD / Digital', label: '—', songIds: ['s06'], color: '#5a6f9c' },
    { id: 'r07', title: '海月のうた', date: '2023.02.28', type: 'Single', format: 'Digital', label: '—', songIds: ['s07'], color: '#3e5577' },
    { id: 'r08', title: '灰色のワルツ', date: '2022.08.07', type: 'Single', format: 'Digital', label: '—', songIds: ['s09'], color: '#7889a8' },
    { id: 'r09', title: '星詠みの少女', date: '2022.04.19', type: 'Single', format: 'CD / Digital', label: '—', songIds: ['s10'], color: '#5d72a0' },
    { id: 'r10', title: '雨と栞', date: '2021.11.03', type: 'Single', format: 'Digital', label: '—', songIds: ['s11'], color: '#8497b8' },
    { id: 'r11', title: '薄明の街', date: '2021.02.14', type: 'Single', format: 'Digital', label: '—', songIds: ['s13'], color: '#324863' },
  ...
  events: [
    ...
    { id: 'e03', date: '2024.10.15', title: '幻奏夜会 vol.3', venue: 'Zepp DiverCity', category: 'ライブ', status: '終了', description: 'シリーズ第三回。' },
    { id: 'e04', date: '2024.08.04', title: 'Summer Music Festival 2024', venue: '幕張メッセ', category: 'フェス', status: '終了', description: '夏フェス出演。' },
    { id: 'e05', date: '2024.06.22', title: 'Studio Showcase Live', venue: '豊洲PIT', category: 'ライブ', status: '終了', description: 'スタジオ合同ライブ。' },
    { id: 'e06', date: '2024.04.10', title: 'TV Music Program 出演', venue: 'テレビ生放送', category: 'メディア', status: '終了', description: '音楽番組出演。' },
    { id: 'e07', date: '2024.02.14', title: 'Valentine Acoustic Night', venue: 'Billboard Live TOKYO', category: 'ライブ', status: '終了', description: 'アコースティック編成の特別公演。' },
    { id: 'e08', date: '2023.12.10', title: '幻奏夜会 vol.2', venue: 'LINE CUBE SHIBUYA', category: 'ライブ', status: '終了', description: 'シリーズ第二回。' },
    { id: 'e09', date: '2023.09.30', title: 'Anime Tie-up Event', venue: '東京国際フォーラム', category: 'コラボ', status: '終了', description: 'アニメタイアップ記念イベント。' },
    { id: 'e10', date: '2023.07.15', title: 'Summer Online Live', venue: 'オンライン配信', category: '配信', status: '終了', description: '夏の配信ライブ。' },
    { id: 'e11', date: '2023.05.20', title: '幻奏夜会 vol.1', venue: 'TSUTAYA O-EAST', category: 'ライブ', status: '終了', description: 'シリーズ初回公演。' },
    { id: 'e12', date: '2023.02.18', title: 'Studio Anniversary Live', venue: '国立代々木競技場', category: 'ライブ', status: '終了', description: 'スタジオ周年ライブ。' },
    { id: 'e13', date: '2022.11.23', title: 'Album Release Party', venue: 'TSUTAYA O-WEST', category: 'リリイベ', status: '終了', description: 'アルバム『残響アーカイブ』リリース記念。' },
    { id: 'e14', date: '2022.08.27', title: 'Online Birthday Live', venue: 'オンライン配信', category: '配信', status: '終了', description: '誕生日記念配信。' },
  ...
  media: [
    ...
    { id: 'm03', type: 'mv', title: '硝子の庭 [Music Video]', date: '2024.03.15', views: '2.1M', songIds: ['s03'], eventId: null, color: '#88a4c4', description: '硝子細工に囲まれた庭園のシーン。' },
    { id: 'm04', type: 'mv', title: '群青の余白 [Music Video]', date: '2023.12.08', views: '1.5M', songIds: ['s04'], eventId: null, color: '#4a5a8a', description: '群青に染まる紙、書かれない手紙。' },
    { id: 'm05', type: 'mv', title: '雪明かり [Music Video]', date: '2023.10.22', views: '780K', songIds: ['s05'], eventId: null, color: '#9bb5d0', description: '雪夜の幻想、ろうそくの灯。' },
    { id: 'm06', type: 'mv', title: '燈籠草 [Music Video]', date: '2023.06.14', views: '1.1M', songIds: ['s06'], eventId: null, color: '#5a6f9c', description: '灯籠の咲く野原を歩く。' },
    { id: 'm07', type: 'mv', title: '海月のうた [Music Video]', date: '2023.02.28', views: '950K', songIds: ['s07'], eventId: null, color: '#3e5577', description: '深海と海月のアニメーション。' },
    { id: 'm08', type: 'mv', title: '残響アーカイブ [Music Video]', date: '2022.11.11', views: '3.4M', songIds: ['s08'], eventId: null, color: '#2c3e5e', description: '代表曲MV。膨大な書架と記憶。' },
    { id: 'm09', type: 'mv', title: '灰色のワルツ [Music Video]', date: '2022.08.07', views: '680K', songIds: ['s09'], eventId: null, color: '#7889a8', description: 'モノクロ、踊る人影。' },
    { id: 'm10', type: 'mv', title: '星詠みの少女 [Music Video]', date: '2022.04.19', views: '1.8M', songIds: ['s10'], eventId: null, color: '#5d72a0', description: '天文台、星図、少女。' },
    { id: 'm11', type: 'mv', title: '雨と栞 [Music Video]', date: '2021.11.03', views: '590K', songIds: ['s11'], eventId: null, color: '#8497b8', description: '雨音と本のページ。' },
    { id: 'm12', type: 'mv', title: '薄明の街 [Music Video]', date: '2021.02.14', views: '720K', songIds: ['s13'], eventId: null, color: '#324863', description: '夜明けの街並みを歩く実写風。' },
    { id: 'm13', type: 'live-clip', title: '残響アーカイブ — 幻奏夜会 vol.2 LIVE', date: '2023.12.20', views: '320K', songIds: ['s08'], eventId: 'e08', color: '#2c3e5e', description: 'ライブ切り抜き映像。' },
    { id: 'm14', type: 'live-clip', title: '硝子の庭 — Valentine Acoustic Night', date: '2024.02.20', views: '180K', songIds: ['s03'], eventId: 'e07', color: '#88a4c4', description: 'アコースティック編成のライブ映像。' },
