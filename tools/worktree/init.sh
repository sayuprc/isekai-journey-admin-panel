...
set_env_value "${repo_root}/src/server/.env" "ASSET_URL" "$WORKTREE_ADMIN_URL"
set_env_value "${repo_root}/src/server/.env" "API_URL" "local.api.isekaijoucho.fan:${WORKTREE_PROXY_HTTPS_PORT}"
